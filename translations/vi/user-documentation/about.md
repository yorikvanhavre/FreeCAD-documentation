...
FreeCAD là một ứng dụng tổng quát cho việc mô hình [CAD](http://en.wikipedia.org/wiki/CAD) 3 chiều theo tham số. Việc phát triển ứng dụng là hoàn toàn theo [Mã nguồn Mở](http://en.wikipedia.org/wiki/Open_source) (với giấy phép LGPL). FreeCAD nhắm trực tiếp đến ngành [kỹ thuật cơ khí](http://en.wikipedia.org/wiki/Mechanical_engineering) và [thiết kế sản phẩm](http://en.wikipedia.org/wiki/Product_design) nhưng cũng phù hợp cho nhiều ứng dụng khác trong các ngành kỹ thuật, chẳng hạn như các chuyên ngành kiến trúc hoặc các chuyên ngành kỹ thuật công trình.
